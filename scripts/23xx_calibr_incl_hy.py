...
st.start = 10  # 10 (use with end after 15) # 20
...
if st.end >= 15:
    ...
    probes = [58, 59, 60]    # 53, 55, 56 3,4 [27,28,29,30] [3,4,15,19,37,38]   #  #  # [1, 2, 3]   # [28, 26, 29, 30][2,3,6,7,8,9,10,11,12,16,19]
    tbl_prefix = 'incl'  # 'incl_p' 'incl_b'  # 'incl', 'i_d'
